  ...
  return (
    <div className="bg-white border border-slate-200 rounded-lg shadow-sm p-5">
      ...
      <div className="bg-[#E0F9FC] rounded-md p-5 text-center">
        <span className="text-[24px] font-[700] leading-[1.2] tracking-[-0.01em] text-foreground">
          {content.value}
        </span>
        {content.valueUnit && (
          <span className="ml-1.5 text-[14px] font-[400] leading-[1.6] text-slate-500">
            {content.valueUnit}
          </span>
        )}
      </div>
      ...
      {/* Context line */}
      <p className="mt-3 text-[14px] font-[400] leading-[1.6] text-slate-500 text-center">
        {content.contextLine}
      </p>
    </div>
  );
